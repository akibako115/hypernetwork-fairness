...
def _run_stage(name: str, config: DictConfig, stage_dir: Path) -> dict[str, Any]:
    ...
    trainer: Trainer = instantiate(config.trainer, callbacks=callbacks, logger=False, default_root_dir=str(stage_dir))
