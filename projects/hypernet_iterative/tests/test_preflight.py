...
from projects.hypernet_iterative.callbacks.fairness_metrics import FairnessMetricsCallback
from projects.hypernet_iterative.data.transform_utils import IMAGENET_FILL, IMAGENET_MEAN, IMAGENET_STD, train_transforms_chexpert, val_transforms_chexpert
...
def test_chexpert_train_transform_composition_matches_the_golden_contract() -> None:
    golden = _golden()
    composition = [str(step) for step in train_transforms_chexpert().transforms]
