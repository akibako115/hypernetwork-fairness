...
| λ | run path | W&B | 状態 |
|---|---|---|---|
| 1.0 | `projects/hypernet_e2e/runs/20260922T111111Z-resnet-chexpert-attribute-invariant-s43-f5cb` | [run](https://wandb.ai/kohki-akiba-kyushu-university/fairness_hypernet/runs/ezpviay3) | 実行中（2026-09-22 20:11 JST 起動） |
| 3.0 | | | 待機（λ=1.0 の完了後） |
| 10.0 | | | 待機（λ=3.0 の完了後） |
